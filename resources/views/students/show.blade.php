    ...
    <div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-2">
                <flux:button :href="route('students.edit', $student)" icon="pencil" wire:navigate>Edit</flux:button>
        ...
        <div class="max-w-lg rounded-xl border border-neutral-200 p-6 dark:border-neutral-700">
            <dl class="space-y-4">
                ...
                <div>
                    <dt class="text-sm text-neutral-500 dark:text-neutral-400">Class</dt>
                    <dd class="font-medium">{{ $student->class }}</dd>
                </div>
                <div>
                    <dt class="text-sm text-neutral-500 dark:text-neutral-400">Created</dt>
                    <dd class="font-medium">{{ $student->created_at->format('M d, Y') }}</dd>
                </div>
            </dl>
        </div>
    </div>
